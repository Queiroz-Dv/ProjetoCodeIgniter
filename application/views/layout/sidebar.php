    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('/') ?>">
        <div class="sidebar-brand-icon rotate-n-15">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-textarea-t"
            viewBox="0 0 16 16">
            <path
      ...
      <!-- Divider -->
      <hr clatrosss="sidebar-divider">
      <!-- Heading -->
      <div class="sidebar-heading">
        Registros
      </div>
      <li class="nav-item">
        <a title='Gerenciador de Clientes' class="nav-link" href="<?php echo base_url('clients'); ?>">
          ...
          <span>Gerenciador de Clientes</span></a>
      </li>
      <!-- Divider -->
      ...
      <!-- Nav Item -->
      <li class="nav-item">
        <a title='Usuário' class="nav-link" href="<?php echo base_url('users'); ?>">
      ...
      <li class="nav-item">
        <a title='Sistema' class="nav-link" href="<?php echo base_url('sistema'); ?>">
