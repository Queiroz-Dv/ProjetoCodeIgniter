                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                            <strong><i class="fas fa-fw fa-exclamation-triangle"></i>&nbsp; &nbsp;<?php echo $message; ?></strong>
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Welcome to <strong>MX-Target</strong> Order and Services</h1>
                                </div>
