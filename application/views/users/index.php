    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a title="Register new user" href="<?php echo base_url('users/add'); ?>" class="btn btn-success btn-sm float-right"><i class='fas far-fw fa-user-plus'></i>&nbsp;New</a>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a title="Edit" href="<?php echo base_url('users/edit/' . $user->id); ?>" class="btn btn-sm btn-primary"><i class="fas far-fw fa-user-edit"></i></a>
                                        <a title="Delete" href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" class="btn btn-sm btn-danger"><i class='fas far-fw fa-user-minus'></i></a>
                                    </td>
                                </tr>
